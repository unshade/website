---
title: "Lac Vert, par le Col de Chésery"
summary: "Une boucle depuis Avoriaz jusqu'au Col de Chésery et au Lac Vert, pile à la frontière suisse."
date: "Sep 5 2026"
draft: false
tags:
  - alpes
...
Départ des Lindarets, près d'Avoriaz, direction le Col de Chésery, pile à la frontière entre la France et la Suisse.

La première partie n'a rien d'intéressant, on remonte simplement les pistes de ski d'Avoriaz. Ça devient bien mieux une fois que le sentier quitte les pistes pour un petit chemin qui grimpe pour de vrai vers la crête.

Le col culmine à exactement 2 000 m. De là, le Lac Vert apparaît juste en contrebas, en Suisse (Valais), et il est vraiment vert. Une rando plutôt facile dans l'ensemble, sans difficulté technique.
